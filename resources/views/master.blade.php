            ...
            <div class="header-top-left">
              <div class="header-top-list">
                <ul>
                  <li>
                    <a href="#">
                      <i class="far fa-envelopes"></i>info@epistores.com
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="far fa-phone-volume"></i>+225 07 08 17 11 19
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="far fa-alarm-clock"></i> Lun - Vend (08h - 18h)
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div
              ...
              <div class="offcanvas-body">
                ...
                <div class="nav-right">
                  ...
                  <div class="nav-btn">
                    <a href="#" class="theme-btn">Contacts
            ...
            <div class="row g-4">
              <div class="col-lg-5">
                <div class="footer-widget-box about-us">
                  ...
                  <p class="mb-4">
                    Au cœur de notre activité globale, le consulting et les technologies financières dans un but de création de valeur et de transmission de leviers utiles à la performance et la productivité de nos entreprises clients.
                  </p>
